#include "shell.h"
/**
 * _yesargv - command-line interpreter that reads input from the user and executes commands based on that input
 *
 * @argv: a pointer to an array of character pointers
 * @envp: a pointer to an array of character pointers
 */
